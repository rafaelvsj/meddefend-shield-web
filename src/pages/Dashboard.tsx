...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-inter flex flex-col lg:flex-row">
      ...
      {/* Main Content Area - Three column layout on larger screens */}
      <div className="flex-1 flex flex-col">
        {/* Header */}
        <header className="bg-white border-b border-slate-200 px-4 lg:px-6 py-3 lg:py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2 lg:space-x-4">
              <h1 className="text-lg lg:text-2xl font-semibold text-slate-800" id="main-heading">
            ...
            <div className="flex items-center space-x-2 lg:space-x-4">
              ...
              <div className="flex items-center space-x-2 lg:space-x-3">
                <Avatar className="h-8 w-8">
                  ...
                  <AvatarFallback className="bg-blue-100 text-blue-800 text-sm">DR</AvatarFallback>
                </Avatar>
                <div className="hidden md:block">
                  <p className="text-sm font-medium text-slate-800">Dr. Roberto</p>
                    ...
                    <Card className="bg-white border border-slate-200 shadow-sm">
                      ...
                      <CardContent>
                        <div className="p-3 lg:p-4 bg-red-50 rounded-lg border border-red-200">
                          <p className="text-slate-800 text-sm lg:text-base leading-relaxed">
