...
const HeroSection = () => {
  useEffect(() => {
    ...
    const elements = document.querySelectorAll('.scroll-reveal-up, .scroll-reveal-fade');
    ...
    <section id="home" className="bg-gradient-to-b from-slate-950 via-gray-950 to-black min-h-screen flex items-center overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 pt-32 relative z-10">
        <div className="text-center max-w-5xl mx-auto">
          <h1 className="scroll-reveal-up text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-12 leading-relaxed tracking-tight drop-shadow-2xl" style={{ transitionDelay: '0.1s' }}>
          ...
          <p className="scroll-reveal-up text-lg sm:text-xl md:text-2xl text-gray-100 mb-10 leading-relaxed font-light font-inter max-w-4xl mx-auto drop-shadow-lg" style={{ transitionDelay: '0.2s' }}>
          ...
          <div className="scroll-reveal-up" style={{ transitionDelay: '0.3s' }}>
          ...
          <p className="scroll-reveal-fade text-sm text-gray-300 mt-6 font-light font-inter" style={{ transitionDelay: '0.4s' }}>
