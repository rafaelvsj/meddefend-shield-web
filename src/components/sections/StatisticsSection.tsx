...
const StatisticsSection = () => {
  ...
  useEffect(() => {
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            if (!animationStarted && entry.target.id === 'statistics') {
    ...
    const elements = document.querySelectorAll('#statistics, .scroll-reveal-up, .scroll-reveal-scale');
  ...
  return (
    <section className="py-32 bg-black" id="statistics">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="scroll-reveal-up text-center mb-20" style={{ transitionDelay: '0.1s' }}>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          <Card className="scroll-reveal-scale text-center p-12 bg-gray-900 border-gray-700 shadow-xl rounded-3xl transition-all duration-300 hover:scale-105 hover:shadow-2xl" style={{ transitionDelay: '0.2s' }}>
          ...
          <Card className="scroll-reveal-scale text-center p-12 bg-gray-900 border-gray-700 shadow-xl rounded-3xl transition-all duration-300 hover:scale-105 hover:shadow-2xl" style={{ transitionDelay: '0.3s' }}>
            <CardContent className="p-0">
          ...
          <Card className="scroll-reveal-scale text-center p-12 bg-gray-900 border-gray-700 shadow-xl rounded-3xl transition-all duration-300 hover:scale-105 hover:shadow-2xl" style={{ transitionDelay: '0.4s' }}>
            <CardContent className="p-0">
        ...
        <div className="scroll-reveal-up bg-gradient-to-r from-gray-800 to-gray-900 p-12 rounded-3xl text-center border border-gray-700 shadow-xl transition-all duration-300 hover:shadow-2xl" style={{ transitionDelay: '0.5s' }}>
