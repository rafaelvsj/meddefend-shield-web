-- FASE 0: Anti-sobrescrita scanner e FASE 1: View canônica para leitura única

-- Criar view canônica user_plan_v1 (idempotente)
...
alter view public.user_plan_v1 set (security_barrier = true, check_option = local);

-- Policy: leitura do próprio plano
...
-- Policy: leitura ampla por admin/owner
...
-- FASE 4: Função central para escrita de planos com auditoria
