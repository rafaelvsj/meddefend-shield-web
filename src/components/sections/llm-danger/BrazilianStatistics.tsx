      ...
      <div className="grid md:grid-cols-3 gap-6">
        <Card className="bg-gray-800 border-gray-700 hover:shadow-lg transition-all duration-300">
          <CardContent className="p-6 text-center">
            <div className="text-2xl sm:text-3xl font-bold text-blue-400 mb-2">{processesVsDoctors.toLocaleString()}</div>
        ...
        <Card className="bg-gray-800 border-gray-700 hover:shadow-lg transition-all duration-300">
          <CardContent className="p-6 text-center">
            <div className="text-2xl sm:text-3xl font-bold text-blue-400 mb-2">198%</div>
        ...
        <Card className="bg-gray-800 border-gray-700 hover:shadow-lg transition-all duration-300">
          <CardContent className="p-6 text-center">
            <div className="text-2xl sm:text-3xl font-bold text-blue-400 mb-2">R$ 500 mil</div>
