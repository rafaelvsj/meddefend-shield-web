    ...
    <section id="home" className="bg-gradient-to-b from-slate-950 via-gray-950 to-black min-h-screen flex items-center overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 pt-32 relative z-10">
        <div className="text-center max-w-5xl mx-auto" data-animate id="hero-content">
          <h1 className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-12 leading-relaxed transition-all duration-1000 tracking-tight drop-shadow-2xl ${visibleElements.has('hero-content') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <p className={`text-lg sm:text-xl md:text-2xl text-gray-100 mb-10 leading-relaxed font-light font-inter max-w-4xl mx-auto transition-all duration-1000 delay-300 drop-shadow-lg ${visibleElements.has('hero-content') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
