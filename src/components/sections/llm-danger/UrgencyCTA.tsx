...
const UrgencyCTA = ({ isVisible }: UrgencyCTAProps) => {
  return (
    <div className={`text-center transition-all duration-1000 delay-900 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
